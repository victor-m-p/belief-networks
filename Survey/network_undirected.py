...
# 2. Create an undirected Graph from the aggregated DataFrame
...
plt.axis("off")
plt.tight_layout()
plt.savefig(f"fig/personal_{participant_id}_undirected.png")
...
plt.axis("off")
plt.tight_layout()
plt.savefig(f'fig/complete_{participant_id}_undirected.png')