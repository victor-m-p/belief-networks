...
d = {
    ...
    'Which party did you vote for at the last national election, and why did you vote for that party? If you did not vote in the last national election, why?': 'In the last election (Denmark) I voted for Radikale Venstre. I was mixed about this decision as I do not agree with all of their policies, but overall they do represent my position, being center-left, being very progressive (e.g., on gender questions, tackling climate change, investing in education, etc.) while also being reform oriented and globally oriented (e.g., strongly EU positive party).',
