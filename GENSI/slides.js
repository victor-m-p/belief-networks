...
if (isIE() || isMobile()) {
  ...
  var slide_0 = d3.select("svg").append("g") // probably utrecht logo somewhere
    .attr("id", "slide0");
  slide_0.append("rect")
    .style("fill", "white")
    .attr("x", 0)
  ...
  slide_0.append("text")
    ...
    .text("Some question in bold text")
    .call(wrap, textWidth);
  slide_0.append("text")
    .attr("class", "slideText")
    .attr("x", center - textWidth / 2)
    .attr("y", text_offset_top + lineHeight * 5)
    .text("Some text we can put in")
    .call(wrap, textWidth);
  slide_0.append("text")
    .attr("class", "slideText")
    .attr("x", center - textWidth / 2)
...
slide1.append("text")
  ...
  .text("Consent form here.")
  .call(wrap, textWidth);
slide1.style("display", "none");

// Slide 2 (random information / instructions)
...
slide3.append("text")
  ...
  .text("Something something people")
  .call(wrap, textWidth);
slide3.append("text")
  .attr("class", "slideText")
  .attr("x", center - (textWidth / 2))
  .attr("y", text_offset_top + lineHeight * ($('#slide3 .slideText tspan').length + $('#slide3 .slideText').length - 1))
  .text("Name up to 8 people (e.g., close or discuss important matters with)")
  .call(wrap, textWidth);
slide3.append("text")
  .attr("class", "slideText")
...
slide4.append("text")
  ...
  .text("Drag to the box that best describes.")
  .call(wrap, textWidth);
...
slide_5.append("text")
  ...
  .attr("x", center - (textWidth / 2))
  .attr("y", text_offset_top)
  .text("We can ask binary questions as well (e.g., which are men?)")
  .call(wrap, textWidth);
slide_5.append("text")
  .attr("class", "slideText")
  .attr("x", center - (textWidth / 2))
